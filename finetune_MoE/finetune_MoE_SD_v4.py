...
def replace_ffn_with_deepspeed_moe(model, config, moe_config):
    ...
    def create_moe_wrapper(original_layer, expert_count, top_k_experts):
        ...
        return moe, shared_expert, shared_alpha, layer_expert_bias, layer_lang_embed, layer_lang_proj
    ...
    for idx in moe_layers:
        ...
        # 创建MoE并替换
        layer.moe_layer, layer.shared_expert, layer.shared_alpha, layer.expert_bias, layer.lang_embed, layer.lang_proj = create_moe_wrapper(layer, num_experts, top_k)
        # with torch.no_grad():
