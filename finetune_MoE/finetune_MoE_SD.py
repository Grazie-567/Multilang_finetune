...
class DeepSpeedMoETrainer(Seq2SeqTrainer):
    ...
    def __init__(self, probs, teacher_model=None, old_language="en", *args, **kwargs):
        ...
        self.hidden_lambda = 0.2       # hidden state distillation
    ...
    def compute_loss(
        ...
        **kwargs
        ...
        if teacher_logits is not None:
            ...
            distill_total = (
                self.distill_lambda * logit_loss
                + self.hidden_lambda * hidden_loss
                + self.lang_lambda * lang_loss
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--main_data_path", default="/mnt/lv2/FLEURS/cache/main_data_large")
