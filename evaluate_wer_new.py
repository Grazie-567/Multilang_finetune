...
if __name__ == "__main__":
    ...
    parser.add_argument("--processor_path", default="", type=str)
    ...
    parser.add_argument("--save_path", default="eval_results/shared_last8_last2", help="保存评估结果的目录")
    ...
    model = load_whisper_model(model_path, device=args.device) # 从checkpoint加载模型
